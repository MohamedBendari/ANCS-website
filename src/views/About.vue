...
.p-card h3 { font-size: 24px; margin-bottom: 15px; color: #fff; }
.p-card p { color: rgba(255,255,255,0.6); line-height: 1.6; }
...
.step-card h3 { font-size: 20px; margin-bottom: 12px; color: #fff; }
.step-card p { font-size: 14px; color: rgba(255,255,255,0.5); line-height: 1.6; }
