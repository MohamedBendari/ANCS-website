...
.btn { padding: 14px 30px; border-radius: 10px; text-decoration: none; font-weight: 600; transition: 0.3s; font-family: inherit; cursor: pointer; font-size: 15px; }
...
.preview-box {
  margin-top: 40px; background: #0b1c2c; padding: 20px;
